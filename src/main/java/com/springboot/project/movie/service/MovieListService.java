...
public interface MovieListService {
	...
	public int like_check(String number, String mov_idn);  // 좋아요 클릭시 총 좋아요 증가, 하트 채워짐
	public void like_check_cancel(String number, String mov_idn); // 좋아요 취소시 총 좋아요 감소, 하트 비워짐
	// 유저 별점 관련
