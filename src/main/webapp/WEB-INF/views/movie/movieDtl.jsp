		...
		<section id="wrap_top">
			<div id="main_top">
				...
				<div class="title_block_container">
					...
					<input type="hidden" class="mov_idn" value="${movie_dtl.mov_idn }">
						<h1>${movie_dtl.mov_title }</h1>
						<div>
							<li><a>${movie_dtl.mov_release }</a> ㆍ<a>
									${movie_dtl.mov_age } </a>ㆍ ${movie_dtl.mov_runtime }</li>
						</div>
					</div>
